...
class _FriendRequestPageState extends State<FriendRequestPage> {
  ...
  Future<void> _getFriendshipRequests() async {
    var result = await friendshipService.getFriendshipRequests();
    setState(() {
      _accountList = result;
                        ...
                        children: [
                          MouseRegion(
                            ...
                            child: IconButton(
                              ...
                              color: _isClearButtonHoveringList[index] ? Colors
                                  .red : Colors.black,
                              onPressed: () async {
                          ...
                          MouseRegion(
                            ...
                            child: IconButton(
                              ...
                              color: _isCheckButtonHoveringList[index] ? Colors
                                  .green : Colors.black,
                              onPressed: () async {
                                if (await friendshipService
                                    .postFriendshipRequest(account.accountId)) {
                                  _removeFriend(index);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('${account
                                          .userName} erfolgreich hinzugefuegt.'),
                                    ),
                                  );
                                } else {
                                  ScaffoldMessenger.of(context).showSnackBar(
                ...
                children: [
                  ...
                  MouseRegion(
                    ...
                    child: IconButton(
                      ...
                      color: _isAddButtonHovering ? Colors.green : Colors.black,
